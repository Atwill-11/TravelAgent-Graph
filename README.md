...
│           ▼              ▼              ▼                    │
│  ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐
│  │ 景点子 Agent │ │ 酒店子 Agent │ │ 天气子 Agent │ │ RAG子 Agent │
│  │ Attraction  │ │   Hotel     │ │  Weather    │ │  Knowledge  │
│  └─────────────┘ └─────────────┘ └─────────────┘ └─────────────┘
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
...
- **智能任务追加**：`plan_node` 支持修改模式，根据用户反馈生成**完整替换任务**（而非增量任务），确保子智能体能够正确执行
...
│   │   │   │   ├── agents/    # Agent 定义
│   │   │   │   │   ├── sub_agents/         # 景点/酒店/天气/RAG子 Agent
