...
export interface SSEExecuteTask {
  task: string;
  type: string;
  type_display: string;
  icon: string;
...
export interface SSEExecuteStartEvent {
  task_name: string;
  task_type: string;
...
export interface SSEExecuteEndEvent {
  task_name: string;
  task_type: string;
  task_type_display: string;
  task_icon: string;
...
export interface SSESummarizeStartEvent {
  message: string;
}

export interface SSESummarizeProgressEvent {
  message: string;
}

export interface SSESummarizeEndEvent {
  status: "completed" | "failed";
  message: string;
}

export interface SSEExecuteEvent extends SSEStepEvent {
  completed_tasks: SSEExecuteTask[];
  failed_tasks: SSEExecuteTask[];
  pending_tasks: SSEExecuteTask[];
  total_tasks: number;
